...
static void query(void)
{
    ...
    gimp_install_procedure(PLUG_IN_PROC,
        _("Clean rain, Derain, Remove rain"),
        _("More_Derain_Help"),
        "Dell Du <18588220928@163.com>",
        "Dell Du",
        "2020-2024", _("Rain"), "RGB*, GRAY*", GIMP_PLUGIN, G_N_ELEMENTS(args), 0, args, NULL);
...
static GimpPDBStatusType start_image_derain(gint32 drawable_id)
{
    ...
    recv_image = vision_image_service((char*)"image_derain", send_image, NULL);
...
run(const gchar* name, gint nparams, const GimpParam* param, gint* nreturn_vals, GimpParam** return_vals)
{
    ...
    *return_vals = values;
    ...
    values[0].data.d_status = start_image_derain(drawable_id);
