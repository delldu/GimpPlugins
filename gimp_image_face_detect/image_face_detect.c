...
static void query(void)
{
    ...
    gimp_install_procedure(PLUG_IN_PROC,
        ...
        "Dell Du",
        "2020-2024",
        _("_Face"), "RGB*, GRAY*", GIMP_PLUGIN, G_N_ELEMENTS(args), 0, args, NULL);
...
static GimpPDBStatusType start_image_face_detect(gint32 drawable_id)
{
    ...
    vision_save_image_as_layer(recv_image, "detect_face", image_id, 50.0);
...
run(const gchar* name, gint nparams, const GimpParam* param, gint* nreturn_vals, GimpParam** return_vals)
{
    ...
    *return_vals = values;
    ...
    values[0].data.d_status = start_image_face_detect(drawable_id);
