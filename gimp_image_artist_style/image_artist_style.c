...
static IMAGE *artist_style_rpc_service(IMAGE * send_image)
{
	return normal_service(AI_TASKSET, "image_artist_style", send_image, NULL);
}

static GimpPDBStatusType start_image_artist_style(gint32 drawable_id)
{
	gint channels;
	GeglRectangle rect;
...
run(const gchar * name, gint nparams, const GimpParam * param, gint * nreturn_vals, GimpParam ** return_vals)
{
	...
	*return_vals = values;
	...
	status = start_image_artist_style(drawable_id);
