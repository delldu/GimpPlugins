...
#define PLUG_IN_PROC "gimp_image_mlsd"
...
static GimpPDBStatusType start_image_mlsd(gint32 drawable_id)
{
    gint channels;
    GeglRectangle rect;
    ...
    // vision_save_image_to_gimp(recv_image, (char *)"lines");
    vision_save_image_as_layer(recv_image, "detect_lines", image_id, 50.0);
...
run(const gchar* name, gint nparams, const GimpParam* param, gint* nreturn_vals, GimpParam** return_vals)
{
    ...
    *return_vals = values;
    ...
    values[0].data.d_status = start_image_mlsd(drawable_id);
