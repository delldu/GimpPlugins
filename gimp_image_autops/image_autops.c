...
#define PLUG_IN_PROC "gimp_image_autops"
...
static void query(void)
{
    ...
    gimp_install_procedure(PLUG_IN_PROC,
        _("Beautify photo, Automatic !"),
        _("More_Autops_Help"),
        "Dell Du <18588220928@163.com>",
        "Dell Du",
        "2020-2024", _("Autops"), "RGB*, GRAY*", GIMP_PLUGIN, G_N_ELEMENTS(args), 0, args, NULL);

    gimp_plugin_menu_register(PLUG_IN_PROC, "<Image>/AI/Beautify/");
}

static GimpPDBStatusType start_image_autops(gint32 drawable_id)
{
    gint channels;
    GeglRectangle rect;
    IMAGE *send_image, *recv_image;

    gimp_progress_init("Autops ...");
    ...
    recv_image = vision_image_service((char*)"image_autops", send_image, NULL);
...
run(const gchar* name, gint nparams, const GimpParam* param, gint* nreturn_vals, GimpParam** return_vals)
{
    ...
    *return_vals = values;
    ...
    values[0].data.d_status = start_image_autops(drawable_id);
