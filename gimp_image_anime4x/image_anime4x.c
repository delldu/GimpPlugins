...
static gboolean anime_scale_times_dialog()
{
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radio4), (anime_scale_times == 4));
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radio3), (anime_scale_times == 3));
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radio2), (anime_scale_times == 2));
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radio1), (anime_scale_times == 1));
...
static void query(void)
{
    ...
    gimp_install_procedure(PLUG_IN_PROC,
        ...
        "Dell Du",
        "2020-2024", _("_Anime Image..."), "RGB*, GRAY*", GIMP_PLUGIN, G_N_ELEMENTS(args), 0, args, NULL);
...
run(const gchar* name, gint nparams, const GimpParam* param, gint* nreturn_vals, GimpParam** return_vals)
{
    ...
    *return_vals = values;
    ...
    case GIMP_RUN_INTERACTIVE:
        ...
        gimp_get_data(PLUG_IN_PROC, &anime_scale_times);
        if (! anime_scale_times_dialog())
            return;
        // Save values for next ...
        gimp_set_data(PLUG_IN_PROC, &anime_scale_times, sizeof(anime_scale_times));
        break;
    ...
    values[0].data.d_status = start_image_anime4x(drawable_id);
